...
scripts/config --disable CONFIG_KVM_COMMON
scripts/config --disable CONFIG_KVM_X86
...
scripts/config --disable CONFIG_KVM_SW_PROTECTED_VM
scripts/config --disable CONFIG_KVM_SMM
scripts/config --disable CONFIG_KVM_EXTERNAL_WRITE_TRACKING
scripts/config --disable CONFIG_KVM_GENERIC_DIRTYLOG_READ_PROTECT
scripts/config --disable CONFIG_KVM_GENERIC_PRE_FAULT_MEMORY
scripts/config --disable CONFIG_KVM_GENERIC_MMU_NOTIFIER
scripts/config --disable CONFIG_KVM_GENERIC_HARDWARE_ENABLING
scripts/config --disable CONFIG_KVM_GENERIC_MEMORY_ATTRIBUTES
scripts/config --disable CONFIG_KVM_GENERIC_PRIVATE_MEM
